-- =====================================================
-- CUSTOM FIELD DEFINITIONS - TABLES ONLY
-- =====================================================
-- This migration creates only the custom field tables
-- (functions already exist in the database)
-- =====================================================
...
CREATE TABLE IF NOT EXISTS custom_field_audit (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
  custom_field_id UUID REFERENCES custom_field_definitions(id) ON DELETE SET NULL,
  company_id UUID NOT NULL REFERENCES companies(id) ON DELETE CASCADE,
...
-- =====================================================
-- 7. CREATE VIEW FOR USAGE STATISTICS
-- =====================================================
...
SELECT '✅ Custom Field Definitions tables created successfully!' as status;
