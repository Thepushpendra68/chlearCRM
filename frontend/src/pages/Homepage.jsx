    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50">
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden fixed inset-0 z-[70]">
          ...
          <div className="fixed top-0 right-0 z-[70] w-80 max-w-[85vw] sm:max-w-md overflow-y-auto bg-white shadow-2xl transform transition-transform duration-300 ease-in-out max-h-screen">
            ...
            <div className="px-6 py-6">
              <div className="space-y-1">
                <div className="pb-4 space-y-3 border-b border-gray-200">
                  <a 
                    href="#features" 
                    className="block rounded-lg px-4 py-3 text-base font-semibold leading-6 text-gray-900 hover:bg-gray-50 transition-colors"
                    onClick={() => setMobileMenuOpen(false)}
                  >
                    Features
                  </a>
