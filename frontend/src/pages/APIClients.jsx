...
function APIClients() {
  ...
  const handleCreate = async (e) => {
    ...
    try {
      ...
      // Build custom field mapping object
      const customFieldMapping = {};
      fieldMappings.forEach(mapping => {
        if (mapping.source && mapping.target) {
          customFieldMapping[mapping.source] = mapping.target;
        }
      });
            ...
            <div className="p-6">
              ...
              <form onSubmit={handleCreate} className="space-y-4">
                ...
                <div className="border-t pt-4 mt-4">
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    Custom Field Mapping (Advanced - Optional)
                  </label>
                  <p className="text-xs text-gray-500 mb-3">
                    Map custom field names from your client's form to CRM field names. Leave empty to store all fields as-is.
                  </p>
                  ...
                  {fieldMappings.map((mapping, index) => (
                    <div key={index} className="flex gap-2 mb-2">
                      <input
                        type="text"
                        placeholder="Client field name (e.g., company_name)"
                      ...
                      <input
                        type="text"
                        placeholder="CRM field name (e.g., company)"
                  ...
                  <button
                    type="button"
                    onClick={() => setFieldMappings([...fieldMappings, { source: '', target: '' }])}
                  ...
                  <div className="mt-3 p-3 bg-blue-50 rounded-lg border border-blue-100">
                    <p className="text-xs text-blue-800">
                      <strong>Example:</strong> If your client's form uses <code className="bg-blue-100 px-1 py-0.5 rounded">company_name</code> but CRM expects <code className="bg-blue-100 px-1 py-0.5 rounded">company</code>, map: <code className="bg-blue-100 px-1 py-0.5 rounded">company_name → company</code>
                    </p>
                  </div>
                </div>
