...
const Dashboard = () => {
  ...
  const wonStatusTitle = useMemo(() => {
    const wonStatuses = leadStatuses.filter(
      (option) => option.metadata?.is_won,
    );
  ...
  const getStatusLabel = useCallback(
    (status) =>
      getStatusOption(status)?.label || formatValue(status, "Unknown"),
    ...
    () => [
      {
        ...
        changeType: stats.total_leads_change?.startsWith("+")
          ? "increase"
          : "decrease",
      },
      {
        ...
        changeType: stats.new_leads_change?.startsWith("+")
          ? "increase"
          : "decrease",
      },
      {
        ...
        changeType: stats.converted_leads_change?.startsWith("+")
          ? "increase"
          : "decrease",
      },
      {
        ...
        changeType: stats.conversion_rate_change?.startsWith("+")
          ? "increase"
          : "decrease",
      },
    ],
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      {/* Stats */}
      <div
        className="grid gap-3 md:gap-4 lg:gap-5 mb-8"
              ...
              <div key={item.name} className="card">
                <div className="card-body">
                  <div className="flex items-center gap-3 md:gap-4">
                    <div className="flex-shrink-0">
                      <item.icon
                        className="h-6 w-6 md:h-8 md:w-8 text-primary-600 flex-shrink-0"
                        aria-hidden="true"
                      />
                    </div>
                    <div className="min-w-0 flex-1">
                ...
                {leadSourceStats.map((source, index) => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center">
                        <div
                          className={`h-3 w-3 rounded-full ${color} mr-3`}
                        ></div>
